...
/**
 * Handlers are used to parse and serialize payloads for specific mime types. You can register a custom handler via
 * the register method. You can also override a default parser in this way.
 */
