...
class Response {
    ...
    public function _interpretHeaders()
    {
        ...
        // RFC 2616 states "text/*" Content-Types should have a default charset of ISO-8859-1. "application/*" and other
        // Content-Types are assumed to have UTF-8 unless otherwise specified.
